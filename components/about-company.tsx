    ...
    <section id="about-company" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#344458] mb-4 font-poppins">About Our Company</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <Card className="border-[#c99d46]/20">
          ...
          <div className="lg:pl-8">
            <img
              src="/cdm-office-interior.png"
              alt="CDM Enterprise Office"
