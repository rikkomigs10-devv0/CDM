      ...
      <div className="container mx-auto px-4">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">123 Construction Ave, Builder City, BC 12345</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">info@sphereconstructions.com</p>
                    </div>
                  </div>
                </div>
              </CardContent>
        ...
        <div className="mt-16 pt-8 border-t border-border text-center">
          <p className="text-muted-foreground">
            © 2024 Sphere Constructions. All rights reserved. | Building Excellence Since 1995
          </p>
        </div>
      </div>
    </section>
